...
contract Native_Autocompound is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public immutable lockDurationMax;
    ...
    constructor(
        ...
        pid = _pid;
        lockDurationMax = _lockDurationMax;
    ...
    /**
     * @notice set lockDuration
     */
    function setLockDuration(uint256 _lockDuration) external onlyAdmin {
        require(_lockDuration <= lockDurationMax, "lockDurationMax exceeded.");
